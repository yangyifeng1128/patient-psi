...
import { initialProfile, PatientProfile } from './data/patient-profiles';
import { patientTypeDescriptions, patientTypes } from './data/patient-types';
...
export async function getPrompt(): Promise<string> {
  ...
  // console.log(profile);
  const prompt = formatPromptString(profile ?? initialProfile);
  return prompt;
}

async function formatPromptString(data: PatientProfile): Promise<string> {
