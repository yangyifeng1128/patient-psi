  ...
  return (
    ...
    >
      ...
      <g mask="url(#mask0_91_2047)">
        ...
        />
        <rect fill={`url(#gradient-${id}-2)`} height="6.4" width="1.06667" x="11.2222" y="4.8" />
      </g>
    </svg>
  );
}
...
function IconVercel({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg aria-label="Vercel logomark" className={cn('size-4', className)} role="img" viewBox="0 0 74 64" {...props}>
